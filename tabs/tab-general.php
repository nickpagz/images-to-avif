...
<form method="post" action="">
	...
	<table class="form-table">
		<tr>
			<th>
				<label for="q_field_1"><?php _e( 'Images quality', 'images-to-avif' ) ?></label> 
			</th>
			<td>
				<input type="number" min="1" max="100" step="1" name="avif_quality" placeholder="85" value="<?php echo intval( $this->settings['avif_quality'] ) ?>" id="q_field_1"> %
			</td>
		</tr>
		<tr>
			<th>
				<label for="q_field_2"><?php _e( 'Convert images to avif during upload', 'images-to-avif' ) ?></label> 
			</th>
			<td><?php
		...
		<tr>
			<th>
				<label for="q_field_3"><?php _e( 'Conversion method', 'images-to-avif' ) ?></label> 
			</th>
			<td><?php
				$methods = get_site_option('images_to_avif_methods');
				itw_render_select(array(
					'name' => 'method',
					'id' => 'q_field_3',
		...
		<tr>
			<th>
				<label><?php _e( 'Convert these image extensions to avif:', 'images-to-avif' ) ?></label> 
			</th>
			<td>
		...
		<tr>
			<th>
				<label><?php _e( 'Delete original images after conversion', 'images-to-avif' ) ?></label> 
			</th>
			<td><?php
				itw_render_select(array(
				...
				<section class="notice notice-alt notice-error">
					<p><strong><?php _e( 'Be EXTREMELY CAREFUL with this option!', 'images-to-avif' ) ?></strong></p>
					<p>
						<?php _e( 'This will PERMANENTLY DELETE ORIGINAL IMAGES (only avif versions will exist)!', 'images-to-avif' ) ?><br>
						<?php _e( 'It is a good idea to create some backup.', 'images-to-avif' ) ?><br>
						<?php _e( 'You CAN NOT DEACTIVATE THIS PLUGIN when you use this option, otherwise all converted images will throw 404 ERROR!', 'images-to-avif' ) ?><br>
						<small><?php _e( '(Of course, you can activate it back to fix this problem.)', 'images-to-avif' ) ?></small>
					</p>
				</section>
			</td>
		</tr>
